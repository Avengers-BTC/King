  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'neon-gradient': 'linear-gradient(45deg, #ff005c, #00e0ff)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        'glow-pulse': {
          '0%, 100%': { boxShadow: '0 0 20px rgba(255, 0, 92, 0.3)' },
          '50%': { boxShadow: '0 0 30px rgba(255, 0, 92, 0.6)' },
        },
        'float': {
